                ...
                <tr>
                    ...
                    <td>
                        <form method="post" action="{{ route('category.destroy',$category) }}">
                            @csrf
                            @method('delete')
                            <button class="text-decoration-none text-dark" type="submit"><img src="{{ asset('assets/admin/images/trash-can-svgrepo-com.svg') }}" onclick = "return confirm('Are you sure you want to delete this item?')"></button>
                        </form>
                    </td>
                </tr>
                @endforeach
