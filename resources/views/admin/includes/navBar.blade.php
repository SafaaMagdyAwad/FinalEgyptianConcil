      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item dropdown">
            <a class="nav-link {{ active('user.*') }}  dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
              aria-expanded="false">
              USERS
            </a>
          ...
          <li class="nav-item dropdown">
            <a class="nav-link {{ active('topic.*') }} dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
              aria-expanded="false">
              TOPICS
            </a>
            <ul class="dropdown-menu">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link {{ active('category.*') }}  dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
              aria-expanded="false">
              CATEGORIES
            </a>
            <ul class="dropdown-menu">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link {{ active('testimonial.*') }}  dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
              aria-expanded="false">
              TESTIMONIALS
            </a>
            <ul class="dropdown-menu">
          ...
          <li><a class="nav-item {{ active('message.*') }}  nav-link" href="{{ route('message.index') }}">MESSAGES</a></li>
        </ul>
      </div>
    </div>
  </nav>
